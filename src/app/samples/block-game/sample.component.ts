...
export class MyScene extends Phaser.Scene {
  ...
  public preload() {
    ...
    this.load.spritesheet('ball', 'assets/images/wobble.png', {
      frameWidth: 20,
      frameHeight: 20
    });
  ...
  public create() {
    ...
    this.physics.add.collider(this.ball, this.bricks, (ball:any, brick: any) => {
      ...
      this.add.tween({
        ...
        onComplete: () => {
          brick.destroy();
          console.log('this.bricks.countActive(true) >>', this.bricks.countActive(true));
    ...
    // this.physics.add.collider(this.ball, this.bricks, (info: any) => {
    //   // brick.destroy();
    ...
    // Life 생성
    this.livesText = this.add.text(this.cameras.main.width - 50, 5, 'Lives: ' + this.lives, {
      font: '18px Arial'
    }); // , fill: '#0095DD'
    this.livesText.setOrigin(1, 0);
    this.lifeLostText = this.add.text(this.cameras.main.width * 0.5, this.cameras.main.height * 0.5, 'Life lost, click to continue', {
      font: '18px Arial'
    }); // , fill: '#0095DD'
