    ...
    /// 안됨
    export class Texture3Component implements AfterViewInit {
        // name = 'Angular';
    ...
    export class MyScene extends Phaser.Scene {
        ...
        public create()  {
            ...
            //   ctx.strokeStyle = "rgba(243 34 34, 1)";
            //   ctx.lineWidth = 20;
            //   ctx.stroke();
            ...
            // ctx.stroke();
            // this.textures.addCanvas('rectTest', rectTest);
            // const rectImage = this.add.image(100, 100, 'rectTest');
            ...
            ctx.stroke();
            // ctx.fillRect(0, 0, 800, 600);
            this.textures.addCanvas('canvasK', canvas); // (key, source)
            // const texture = this.textures.createCanvas('canvastexture', 800, 600);

            this.add.image(0, 0, 'canvasK');
