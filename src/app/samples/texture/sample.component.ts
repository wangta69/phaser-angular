...
export class MyScene extends Phaser.Scene {
  ...
  public create() {
    ...
    const SCALE = 0.1;
    const texture: any = this.textures.createCanvas('canvastexture', 800, 600);

    const textureSmall: any = this.textures.createCanvas(
      'canvastextureSmall',
      SCALE * texture.width,
    ...
    const text = this.add.text(80, 0, 'Erase the grass', {
